...
>
         ...
         className="text-[45px]  font-[500] mt-32 w-full">Flexible <span className='px-[8px] whitespace-nowrap bg-gradient-to-r from-[#00ffff5e] border-l-4 border-l-[#00FFFF] '>Pricing</span></motion.h1>
        <div className="mt-16">
     <PricingText/>
     </div>
     </div>    
