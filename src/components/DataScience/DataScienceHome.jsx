  ...
  <p className='text-[16px] font-[500] whitespace-nowrap flex justify-center items-center gap-3 text-[#acacb6]'>
    ...
    <span class="flex justify-center items-center h-3 w-3 relative ">
      ...
      <span class="relative inline-flex rounded-full h-[7px] w-[7px] bg-[#11D17F]"></span>
        ...
        <h1 className='md:text-[78px] text-[44px] font-[500] max-w-[673.97px] mt-5 leading-[50px] md:leading-[90px] msm1:px-0 px-5 '>Fresh Data Science<h1 className='px-[8px] msm1:whitespace-nowrap bg-gradient-to-r from-[#00ffff5e] border-l-4 border-l-[#00FFFF] '>AI Solutions</h1></h1>
