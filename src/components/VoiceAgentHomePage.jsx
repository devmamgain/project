...
<motion.div ref={containRef}
 ...
 className='flex flex-col justify-center  items-center font-Roboto px-[48px]'>
  ...
  <motion.button 
      ...
      className='bg-buttonmaincta text-white  px-[32px] py-[20px] rounded-full flex gap-2 flex-grow msm1:flex-grow-0  justify-center w-[182.92px] h-[63.13px] font-[500] shadow-xl'><img src="https://cdn.prod.website-files.com/66b3f7d1ff69e1e7133402fc/66b3f7d1ff69e1e713340363_Phone.svg"/>Book A Call</motion.button>
    <motion.button 
          onClick={() => navigateTo('#inoutbound')}
          whileHover={{
            scaleX: 1.08,
            opacity:0.8,
                transition: { duration: 0.3 }
              }} 
    className='bg-[#284743] text-textmain-color px-[32px] py-[20px] rounded-full flex-grow msm1:flex-grow-0 text-left md:text-center font-[500]' >View Selection</motion.button>
  </div>
  </div>
  </div>
  </motion.div>
...
export default VoiceAgentHomePage;
