  ...
  <p className='text-[16px] whitespace-nowrap  font-[500] flex justify-center items-center gap-3 text-[#acacb6]'>
    ...
    <span class="flex justify-center items-center h-3 w-3 relative ">
      ...
      <span class="relative inline-flex rounded-full h-[7px] w-[7px] bg-[#11D17F]"></span>
        ...
        <h1 className='md:text-[78px] text-[44px] font-[500] max-w-[673.97px] mt-5 leading-[50px] md:leading-[90px]'>We'll <span className='px-[8px] whitespace-nowrap bg-gradient-to-r from-[#00ffff5e] border-l-4 border-l-[#00FFFF] '>support </span>you every step.
    </h1>
 
  <div className='flex text-[16px] flex-wrap gap-3 justify-center mt-10'>
  <motion.button 
    onClick={() => navigateTo('#contact-us')}
      ...
      className='bg-buttonmaincta shadow-xl text-white  px-[32px] py-[20px] rounded-full flex gap-2  w-[182.92px] h-[63.13px] font-[500]'><img src="https://cdn.prod.website-files.com/66b3f7d1ff69e1e7133402fc/66b3f7d1ff69e1e713340363_Phone.svg"/>Book A Call</motion.button>
    <motion.button 
      whileHover={{
        scaleX: 1.08,
        opacity:0.8,
    ...
    className='bg-[#284743] text-textmain-color px-[32px] py-[20px] rounded-full  text-left md:text-center font-[500]' >Discover Pricing</motion.button>
  </div>
  </div>
  </div>
  </motion.div>
